...
(() => {
  ...
  const state = {
    ...
    view: ['days', 'flights', 'guide'].includes(params.get('view')) ? params.get('view') : 'days',
  ...
  function render(scroll = false) {
    ...
    main.innerHTML = (state.view==='days'?daily():state.view==='flights'?flights():guide())+`<p class="status" role="status">${statusText()}</p>`;
